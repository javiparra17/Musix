# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-06-05 09:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=b'instruments')),
            ],
        ),
        migrations.CreateModel(
            name='Musician',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affected', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='affected', to='main.Musician')),
                ('reported', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='reported', to='main.Musician')),
            ],
        ),
        migrations.CreateModel(
            name='Song',
            fields=[
                ...
                ('tune', models.CharField(choices=[(b'A', b'A'), (b'B', b'B'), (b'C', b'C'), (b'D', b'D'), (b'E', b'E'), (b'F', b'F'), (b'G', b'G')], max_length=10)),
                ('accidental', models.CharField(blank=True, choices=[(b'#', b'#'), (b'b', b'b')], max_length=10)),
                ('tonality', models.CharField(choices=[(b'M', b'M'), (b'm', b'm')], max_length=10)),
                ('bpm', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(500)])),
                ('description', models.TextField(max_length=500)),
                ('additionalInstruments', models.BooleanField()),
                ('score', models.FileField(blank=True, null=True, upload_to=b'scores')),
                ('finished', models.BooleanField(default=False)),
                ('finishedSong', models.FileField(blank=True, null=True, upload_to=b'songs')),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Musician')),
                ('requiredInstruments', models.ManyToManyField(blank=True, to='main.Instrument')),
            ],
        ),
        migrations.CreateModel(
            name='Track',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sound', models.FileField(upload_to=b'tracks')),
