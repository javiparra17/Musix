...
urlpatterns = [
    ...
    url(r'^acceptTrack/(?P<track_id>\d+)', views.accept_track,
        name='acceptTrack'),
    url(r'^ban/(?P<musician_id>\d+)', views.ban, name='ban'),
    ...
    url(r'^createReport/(?P<musician_username>\w+)', views.create_report,
        name='createReport'),
    ...
    url(r'^deleteReport/(?P<report_id>\d+)', views.delete_report,
        name='deleteReport'),
    ...
    url(r'^processReport/(?P<report_id>\d+)', views.process_report,
        name='processReport'),
    ...
    url(r'^unban/(?P<musician_id>\d+)', views.unban, name='unban'),
