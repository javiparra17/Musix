# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-04-15 14:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_tablespace=b'indexes', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[(b'AcGuitar', b'Acoustic guitar'), (b'Bass', b'Bass'), (b'Cello', b'Cello'), (b'Clarinet', b'Clarinet'), (b'Drums', b'Drums'), (b'ElecGuitar', b'Electric guitar'), (b'Flute', b'Flute'), (b'Harm', b'Harmonica'), (b'Organ', b'Organ'), (b'Piano', b'Piano'), (b'Sax', b'Saxophone'), (b'Synth', b'Synth'), (b'Trombone', b'Trombone'), (b'Trumpet', b'Trumpet'), (b'Violin', b'Violin'), (b'Xylo', b'Xylophone')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Musician',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additionalInstruments', models.CharField(choices=[(b'Y', b'Yes'), (b'N', b'No')], max_length=5)),
                ('finished', models.BooleanField(default=False)),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Musician')),
                ('requiredInstruments', models.ManyToManyField(to='main.Instrument')),
            ],
            options={
                'db_tablespace': 'tables',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[(b'P', b'Pending'), (b'A', b'Accepted'), (b'D', b'Denied')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Track',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('instrument', models.CharField(choices=[(b'AcGuitar', b'Acoustic guitar'), (b'Bass', b'Bass'), (b'Cello', b'Cello'), (b'Clarinet', b'Clarinet'), (b'Drums', b'Drums'), (b'ElecGuitar', b'Electric guitar'), (b'Flute', b'Flute'), (b'Harm', b'Harmonica'), (b'Organ', b'Organ'), (b'Piano', b'Piano'), (b'Sax', b'Saxophone'), (b'Synth', b'Synth'), (b'Trombone', b'Trombone'), (b'Trumpet', b'Trumpet'), (b'Violin', b'Violin'), (b'Xylo', b'Xylophone')], max_length=100)),
                ('sound', models.FileField(upload_to=b'1')),
                ('musician', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Musician')),
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.Song')),
