# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-02-20 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instruments', models.TextField(choices=[(b'Piano', b'Piano')], max_length=10000)),
        ...
        migrations.CreateModel(
            name='InfoUser',
            fields=[
                ('infoactor_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='main.InfoActor')),
                ('city', models.CharField(blank=True, max_length=50)),
                ('premium', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            bases=('main.infoactor',),
        ),
    ]
