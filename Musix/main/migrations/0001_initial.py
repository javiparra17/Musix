# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-05-29 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accidental', models.CharField(choices=[(b'-', b'Natural'), (b'#', b'Sharp'), (b'b', b'Flat')], max_length=10)),
                ('tonality', models.CharField(choices=[(b'M', b'Mayor'), (b'm', b'Minor')], max_length=10)),
